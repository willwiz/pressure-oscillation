...
def create_pfile(prob: ProblemDef) -> PFile:
    ...
    bc = create_bcpatches(prob["mesh"], svars, fvars, period=1.0, left=-15.0, right=15.0, vel=200)
    solid = create_solid_problem(svars, 30000.0, bc.solid)
